      ...
      <form action="./actions/skillAdd.php" method="POST">
        <div class="shadow overflow-hidden rounded sm:rounded-md">
          <div class="px-4 py-5 bg-white p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 auto-rows-max gap-3">
              <div class="row-start-1 md:col-start-2 col-span-1">
              ...
              <div class="row-start-2 justify-self-center md:col-start-2">
