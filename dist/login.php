              ...
              <div class="px-4 bg-white sm:p-6">
                <div class="grid grid-cols-6 auto-rows-max gap-4">
                  <div class="row-start-1 col-start-1 md:col-span-3">
                    ...
                    <input type="text" name="email" id="email" required class="mt-1 text-gray-700 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                  </div>
                  <div class="row-start-1 col-start-4 md:col-span-3">
                    <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                    <input type="text" name="password" id="password" required class="mt-1 text-gray-700 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                  </div>
                </div>
