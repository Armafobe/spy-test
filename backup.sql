...
-- Listage des données de la table spy.agent : ~6 rows (environ)
...
-- Listage des données de la table spy.contact : ~17 rows (environ)
...
-- Listage des données de la table spy.mission_agent : ~15 rows (environ)
...
INSERT INTO `target` (`id`, `last_name`, `first_name`, `birth_date`, `code_name`, `nationality_id`, `mission_id`) VALUES
	...
	(11, 'Non', 'Oui', '2022-07-01', 'Lupus Lupus', 2, 1);
